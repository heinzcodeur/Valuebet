 ...
 */
final class Version20210805222511 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE athlete DROP ranking');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE athlete ADD ranking INT DEFAULT NULL');
